...
Не применяются к:
- Историческому архиву в `/apeiron/` (framework + seed — сохраняются как зона методологической археологии).
...
- Исторический контекст: «Подробности в `/apeiron/01-primitive/21-consistency-and-independence.md`» (архив).
