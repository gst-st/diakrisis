...
| Тип | Описание | Ответ |
|---|---|---|
| | Терминологическое | Ревизия старого с новым термином |
| | Фактическое (разные значения) | Ревизия + исправление |
| | Статусное (разные маркеры) | Ревизия + корректировка |
| | Ссылочное (мёртвая ссылка) | Обновление ссылки |
| | Формат-нное (несоответствие правилам) | Приведение к правилам |
