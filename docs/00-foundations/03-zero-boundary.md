...
- **Инициальная алгебра** A_init существует по Адамек (1974): при доступность 𝖬 начальная 𝖬-алгебра возникает как colim_{κ<λ} 𝖬^κ(⊥), где λ — регулярный кардинал больший rank(𝖬).
...
**Связь с доступностью**: по теореме Адамек-Росицкий, доступные эндофункторы имеют хорошие свойства представимости; но их **итерации** не всегда представимы. Z_3 — **граница** между представимым и не-представимым в предельном режиме.
...
- **Φ_{23}: Z_2 → Z_3**: для (α_D, κ_D) ∈ Z_2, точка κ_D фиксирует переход представимости (из-за не-доступность 𝖬 при сильных итерациях).
...
Отличие: у Гегеля — диалектическая логика, где движение **необходимо** (Aufhebung); у нас — калибровочной свобода, где конкретная α — **выбор** среди эквивалентных путей.
