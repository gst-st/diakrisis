...
Результат применения этого цикла в Diakrisis — TH-Final ABSOLUTA_TOTALIS (все заявленные «уровень 6» новизны редуцируются к известному).
...
|---|---|---|
| 𝖠 | достижимый эндофунктор | Adámek-Rosický |
| Trace(𝖠) | инициальная 𝖠-алгебра | Adámek 1974 |
| α_Apeiron | фиксированная точка Y-типа | Scott 1972 |
| Escape Theorem | теорема Гёделя II | Gödel 1931 |
