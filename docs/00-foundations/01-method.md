...
**Критерий выхода**: каждая no-go теорема (а) имеет полное формальное доказательство или контур с явной пометкой; (б) размещена в контексте no-go-традиции (Cantor..Lawvere..AFN-T).
