...
**Каноническая форма Diakrisis — (∞,∞)-Diakrisis**: максимальная higher-coherent структура с нетривиальными k-морфизмами для всех k ∈ ℕ.
...
| **2-Diakrisis** | τ_{≤2} | Рабочая для prover'ов (Lean, Coq, Agda) |
...
- **𝓜_Fnd = Trace(𝖠)/gauge** — classifying space всех Rich-оснований (43.T1).
...
- **43.T1**: 𝓜_Fnd = Trace(𝖠)/gauge — classifying space.
...
- **Уровень 5**: foundational примитив (как ZFC, HoTT, CIC).
