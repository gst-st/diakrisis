...
**Dual-AFN-T (109.T)** — дуал AFN-T через 108.T (AC/OC Морита-дуальность, MSFS §10). Устанавливает $\LAbs^{\cE} = \emptyset$: не существует абсолютного акта-энактмента.

**Содержание**: no-go симметрично на стороне практик, не только артикуляций.
**Сила**: Theorem~
ef{thm:dual-afnt} (MSFS §10); параллельна AFN-T через 108.T.
