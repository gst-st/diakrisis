...
#### Точная формулировка области применимости (Yanofsky-сводимость)

**105.T строго формулируется внутри Yanofsky-сводимой области:**

**Определение (Yanofsky-сводимый парадокс).** Самореферентный парадокс $\Pi$ называется *Yanofsky-сводимым*, если его категорное ядро редуцируется к диагональной конструкции $\alpha: Y \to T^Y$ вместе с эндоморфизмом $f: T \to T$ без неподвижной точки в декартово-замкнутом или замкнуто-симметрическо-моноидальном контексте, где $Y$ и $T^Y$ допускают сравнимое индексирование глубины (Yanofsky 2003).

**Yanofsky-сводимы:** Рассел, Кантор, Burali-Forti, Тарский, Ловер, Жирар $\mathrm{Type}: \mathrm{Type}$, Gödel-type диагонали, Curry, Grelling-Nelson — все классические семейства самореференции через диагональ-на-экспоненциалах.

**Не покрыты автоматически 105.T:**
- *Парадоксы Berry-типа*: оперируют предикатом определимости в объемлющей метатеории, а не категорной диагональю на экспоненциалах. Зависят от метатеоретического определимого предиката, не от Yanofsky-структуры в самой $\alpha$.
- *Модальные парадоксы Лёба*: оперируют модальным оператором доказуемости, не диагональю на экспоненциалах. Структурно выходят за рамки Yanofsky 2003.
- *Парадоксы в принципиально неклассических объемлющих логиках* (например, паранепротиворечивых метатеориях с диалетея-валидным отрицанием), где Yanofsky-конструкция перестаёт быть универсальной.

**105.T корректно гарантирует:** иммунность от всех Yanofsky-сводимых парадоксов. Является ли *каждый* возможный самореферентный парадокс в $\mathrm{R\text{-}S}$-основаниях Yanofsky-сводимым — открытая мета-теорема. Соответственно: 106.T (Diakrisis $\in \mathcal{L}_{\mathrm{Cls}}^{\top}$) — теорема **относительно области Yanofsky-сводимости**: любой гипотетический не-Yanofsky-сводимый парадокс, допускаемый артикуляцией, лежал бы вне гарантии 105.T и потребовал бы усиленного условия (T-2f\*\*\*) с дополнительным блокированием на уровне внутреннего языка.

**Согласованность с MSFS:** соответствует scope-формулировке MSFS Theorem `thm:meta-cat` (мета-категоричность $\mathcal{L}_{\mathrm{Cls}}^{\top}$ относительно области Yanofsky-сводимости).
...
**Шаг 3** (совместимость с $\mathbb{I}$). По Лемме 129.L1, $\Phi_\mathbf{F}$ автоматически согласован с интенсиональной стороной через срез-проекцию (MSFS Theorem `thm:slice-locality`).
