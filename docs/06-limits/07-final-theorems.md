...
- **103.T + 104.T + 105.T + 106.T** — maximality proofs: Diakrisis ∈ $\mathcal{L}_{\mathrm{Cls}}^{\top}$ как теорема, [/06-limits/10-maximality-theorems](/06-limits/10-maximality-theorems).
