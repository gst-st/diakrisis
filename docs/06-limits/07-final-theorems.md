...
**Все теоретические вопросы закрыты**. 106 теорем в номерной системе доказаны (кроме [Программа] статусов). Последние добавления (закрытые после основных финальных теорем):
...
Diakrisis **теоретически закрыта** после 106 теорем в номерной системе:
...
Работа Diakrisis как **теории** — завершена на всех четырёх уровнях (extensional, intensional, meta-classification, maximality).
Работа Diakrisis как **проекта** — продолжается через programmes П1–П6.

## Следующий документ

[/10-reference/02-theorems-catalog](/10-reference/02-theorems-catalog) — полный каталог всех 106 теорем в номерной системе (119+ с под-теоремами).
