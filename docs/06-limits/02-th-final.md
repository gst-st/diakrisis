...
**Статус**: [Т] — структурно тавтологическое доказательство (Расселовское самопротиворечие через синтаксис-семантическое сопряжение). Формализация в системе автоматизированного доказательства — программа [Пути Б](/09-applications/00-path-B-uhm-formalization).
