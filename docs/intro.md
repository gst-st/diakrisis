...
flowchart LR
    ...
    T2F["<b>T-2f* + T-2f**</b><br/>стратификация по глубине<br/>+ модальная стратификация<br/>универсальная парадокс-иммунность<br/>105.T (Yanofsky) + 130.T (модальный класс)"]:::axi
...
| Полнота (при условии Lawvere-scope) | стандартная Lawvere-фикса | 87.T |
...
- **105.T** (Max-3) — универсальная парадокс-иммунность через Yanofsky-сводимость: T-2f\* блокирует все Yanofsky-сводимые самореферентные парадоксы (расширение 18.T с пяти именных семейств до универсального класса).
...
- **130.T** — модальная стратификация T-2f\*\* блокирует парадоксы вне Yanofsky-сводимости (Berry, парадоксальное применение Лёба, паранепротиворечивый Curry) через модально-определимостный ранг $\mathrm{md}(P) < \mathrm{md}(\alpha_P)$.
