...
| | Роль |
|---|---|
| **Diakrisis** (уровень $\mathcal{L}_{\mathrm{Cls}}^{\top}$) | Теоретический корпус: 135 теорем (114 ОЦ + 21 Актика, включая 128.T-131.T закрытие открытых вопросов и 133.T-135.T MSFS Q3-Q5 closures) в номерной системе, (∞,∞)-формулировка, пятиосевая абсолютность AFN-T, интенсиональное уточнение + мета-классификация closure + доказательства максимальности (103.T–106.T) |
...
| [06 — Мета-рефлексия](./06-meta-reflection) | Самореференция, граница Ловер |
