...
| | Роль |
|---|---|
| **Diakrisis** (уровень $\mathcal{L}_{\mathrm{Cls}}^{\top}$) | Теоретический корпус: 127 теорем (106 ОЦ + 21 Актика) в номерной системе, (∞,∞)-формулировка, пятиосевая абсолютность AFN-T, интенсиональное уточнение + мета-классификация closure + maximality proofs (103.T–106.T) |
