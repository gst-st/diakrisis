...
**NO-19.C1** (*Метастемология-совместимость*). Гигиена резонирует с антирефлексивной дисциплиной программы Е. Чурилова (anticomplexity.org) — установкой на устранение скрытых «само-» конструкций в пользу явного операторного развёртывания — без философского заимствования: NO-19 формулирует это как формальную теорему о core-pipeline Noesis (тройка $\rho \to \alpha^*$, factorisation, fixpoint), а не как импорт внешнего протокола.
