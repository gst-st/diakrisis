...
| Формальные границы | ✗ | ✗ | ✗ | ✗ | Локальные (стиль M-10) | **пятиосевая абсолютность AFN-T** |
...
**Noesis**: SMT-фильтр + Axi-проверка + границы AFN-T.
