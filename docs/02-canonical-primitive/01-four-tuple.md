...
#### Почему именно 2-категория (а не (∞,1)-категория)

Рассматривались варианты:

- **1-категория**: слишком бедная; не улавливает «переходы между переходами» (2-морфизмы).
- **2-категория**: минимальный уровень, дающий gauge-структуру через автоэквивалентности.
- **(∞,1)-категория**: более богатая, но избыточная для текущих задач; зарезервирована для будущих расширений.
- **(∞,∞)-категория**: слишком общая; трудно управлять.

Выбор **2-категории** — компромисс между богатством и контролируемостью.
