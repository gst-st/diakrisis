...
| 5+ | Мета-структура над 5 | Diakrisis, Lurie HTT на мета-уровне |
...
13 аксиом — результат итеративной минимизации (по П-0.2). В первой формулировке (framework) было ~20+ аксиом. В seed-фазе многие были доказаны как теоремы:
...
Текущие 13 — **независимы** (проверено в seed-фазе).
