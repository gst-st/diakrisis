...
Стандартное изложение использует 2-Diakrisis как **прагматический выбор** (минимальность + proof-assistant tooling), но **каноническая** семантика — (∞,∞). Детали: [/06-limits/06-absoluteness](/06-limits/06-absoluteness).
