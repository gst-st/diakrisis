...
**[Т-набр]** — формализация `/apeiron/01-primitive/45-derived-structures.md`.

## Постановка

Derived categories (Verdier), homological algebra (Cartan-Eilenberg), stable ∞-categories (Lurie HA) — центральные инструменты современной математики. Они:
...
**K_0(A)** = Grothendieck группа классов проективных модулей.
...
Derived + cohesion: derived cohesive ∞-topos (Schreiber).
...
Derived NCG — расширение Connes theory через derived methods.
...
- **Stable ∞-categories**: Lurie formalism.
