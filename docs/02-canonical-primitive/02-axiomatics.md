...
Ни в одной модели **всех** 13 аксиом одновременно удовлетворить *в абсолютной форме* (без κ-стратификации) не удалось и не может быть удалось — что согласуется с AFN-T. 131.T достигает максимума: 13 аксиом с κ-стратификацией в stack-модели, реализуя Diakrisis ∈ $\mathcal{L}_\mathrm{Cls}^\top$.
