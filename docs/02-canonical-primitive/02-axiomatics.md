...
- По AFN-T: полное удовлетворение Axi-8 + accessibility 𝖬 + прочие условия в *абсолютной* форме (без κ-стратификации) — невозможно. Axi-8 реализуется *с κ-стратификацией* в стек-модели (теорема 131.T ниже).
