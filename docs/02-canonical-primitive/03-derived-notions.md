...
По Axi-8 (в строгой форме), α_𝖬 **не** Yoneda-представим. Но в Cat-модели α_𝖬 оказывается Yoneda-представим (поскольку ι в Cat — стандартное вложение). Это — один из аспектов, обсуждаемых в AFN-T.
