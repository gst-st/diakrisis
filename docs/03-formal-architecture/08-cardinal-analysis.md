...
- Каждый объект представим как λ-фильтрованный копредел λ-представимых объектов.
- Имеется достаточно λ-представимых объектов.
...
- Morse-Kelley, NBG.
- Проперные классы — полноправные объекты.
