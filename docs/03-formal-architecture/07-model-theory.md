...
**[Т]** — классические мета-теоремы установлены: 41.T1 полнота (Gödel), 41.T2 компактность (Malcev), 41.T3-T4 Löwenheim-Skolem, 41.T5 stability (Shelah).
...
- Higher-order теоремы — через Henkin-модели или сильные прувер'ы.
