...
**[Т-набр]** — формальная структура установлена.
...
- **Мета-функция 𝓜_Fnd**: moduli stack оснований как объект изучения.
...
- Преобразования: замена эквивалентных типов, пропозициональная truncation.
