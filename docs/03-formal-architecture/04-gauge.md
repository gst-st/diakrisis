...
- Связывает разные основания (ZFC ∼ ETCS как калибровочно-эквивалентные).
...
Совокупность калибровочное преобразований образует **2-группу** 𝐆_gauge.
...
Все эти — **калибровочно-инвариантны**: не меняются при выборе α_math.
...
ρ «указывает», как α связана с α_math. При калибровочное преобразовании:
...
В diff-geom, **connection** на расслоении — способ «параллельно переносить» вдоль пути. При калибровочное преобразовании конкретная форма connection меняется, но **curvature** (кривизна) — инвариант.
...
- **Сохранение**: все калибровочно-инварианты сохраняются через Морита-эквивалентность.
...
- ETCS-формулировка ZFC — калибровочное преобразование.
