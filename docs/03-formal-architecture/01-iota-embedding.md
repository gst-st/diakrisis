...
По стандартной Yoneda-лемме в 2-категорном варианте.

#### Формальная Yoneda для 2-категорий

**Лемма Yoneda 2** (Kelly, 1982): Для 2-категории C, 2-функтор
...
|---|---|---|
| Yoneda для 2-cat | 2-Yoneda embedding | Kelly 1982 |
...
- **Axi-8**: в строгой форме, α_𝖬 **не** Yoneda-представим (часто нарушается в Cat-модели).
...
В Cat-модели часто α_𝖬 оказывается Yoneda-представимым (вопреки Axi-8).

**Решение**: это — известное ограничение модели (часть TH-Final). Работа с не-LP моделями — открытая программа.
