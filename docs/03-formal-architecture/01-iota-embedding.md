...
Для F ∉ Rep(⟪⟫), ι(F) получается через **свободное пополнение** — добавление виртуального объекта, ведущего себя как F.

Формально: расширяем ⟪⟫ до ⟪⟫̃ так, что для каждого непредставимого F добавляется объект α_F с соответствующей хом-структурой.

#### Детали свободное пополнение
...
Это — стандартная **свободное пополнение** (свободное пополнение) 2-категории.
...
- Стадия 2 — стандартная свободное пополнение.
