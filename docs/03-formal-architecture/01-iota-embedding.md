...
Для F ∉ Rep(⟪⟫), ι(F) получается через **свободная когомплетция** — добавление виртуального объекта, ведущего себя как F.

Формально: расширяем ⟪⟫ до ⟪⟫̃ так, что для каждого непредставимого F добавляется объект α_F с соответствующей хом-структурой.

#### Детали свободная когомплетция
...
Это — стандартная **свободная когомплетция** (свободная когомплетция) 2-категории.
...
- Стадия 2 — стандартная свободная когомплетция.
