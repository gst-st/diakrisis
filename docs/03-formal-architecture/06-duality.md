...
В Diakrisis — оба условия обеспечиваются Axi-4 + стандартной доступности.
...
**26.T5**: двойственность коммутирует с калибровочное преобразованиями. 𝐆_gauge × {1, op} — полная группа структурных симметрий.
