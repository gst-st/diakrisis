...
- **Применения**: epistemic logic, modal type theory — потенциальные расширения.

## Теорема

**Теорема 04.T1** (`/apeiron/02-articulation/04-modal-interpretation.md`): 𝖬 — **S4-модальный** оператор.
