...
Для теорем структурного ядра (AFN-T, 55.T–87.T, 98.T–99.T, 100.T–102.T) нормативным источником при Verum-формализации служит **[*MSFS*](/10-reference/04-afn-t-correspondence)** ([Zenodo](https://zenodo.org/records/19755781)): формулировки и доказательства в MSFS — канонические, Diakrisis-документы ссылаются на них. При разработке Lean-формализации этих теорем используется MSFS-нумерация (`thm:afnt-alpha`, thm:horizontal–thm:completeness, и т. д.). Diakrisis-специфические конструкции (канонический примитив, 13 аксиом, калибровка, **доказательства максимальности 103.T–106.T** через T-2f\* и Яновский 2003) формализуются отдельно по [`/06-limits/10-maximality-theorems`](/06-limits/10-maximality-theorems).
