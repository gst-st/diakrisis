...
- **Концептуальная проработка** в framework-корпусе (04-assemblies/uhm).
- **Флагманская сборка** Diakrisis.
...
УГМ формализуется в **собственной** системе — интересный self-referential аспект. Аналог: GR formalized in GR-compatible framework.
...
- **К-Б-2**: предварительно OK (через аксиоматический анализ framework).
