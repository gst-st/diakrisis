...
**[Т-набр]** — формализация `/apeiron/04-assemblies/uhm.md`.
...
**ν_uhm = ω·4** (обосновано в 04-assemblies/uhm §2.3).
...
**I_6 — Self-модель**: функтор φ с self-consistency.
...
- **Self-consistency**: УГМ «описывает» саму себя.
