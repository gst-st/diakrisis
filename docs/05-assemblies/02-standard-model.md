...
- **Hom**: калибровочное преобразования, Lorentz-трансформации.
...
**SM.T1**: 𝐆_gauge^{SM} ≅ U(1) × SU(2) × SU(3). Физические наблюдаемые = калибровочно-инварианты α_SM.
...
- Физические наблюдаемые ↔ калибровочно-инварианты ⟪⟫.
...
- α_SM — специфическая калибровочный класс в α_NCG.
