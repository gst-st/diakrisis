...
| ∞-Topos | α_∞topos | ω·2 | descent + truncation |
...
- ZFC → HoTT: через специфический translation (не Морита, но структурно).
...
- 𝓜_Fnd как moduli — стандартная конструкция moduli stacks.
...
- **Уровень 5**: foundational в существующей традиции.
...
- Не существует «уровня 6» основания (по TH-Final).
