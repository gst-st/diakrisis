...
- **Homotopy-coherent**: все структуры «до гомотопии».
...
**05.T3**: n-truncation τ_{≤n} — n-кратная Π (когезивная модальность).
...
Это — формальная связь когезии и truncation — две точки зрения на одну структуру.
...
- Все аксиомы — с гомотопической coherence.
