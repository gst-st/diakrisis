---
sidebar_position: 0
title: Actic — действие-центричный дуал Diakrisis
---
...
>
> Actic (от греч. ἄκτος, лат. *actus* — «акт, действие»; в русской традиции — *Актика* Михаила Боярина) — формальный действие-центричный (ДЦ) дуал канонического примитива. Дополняет ⟪·⟫-стек Диакрисиса двойственным ⟫·⟪-стеком актов и энактментов, между которыми установлена категорная Морита-дуальность, а не оппозиция.

## Статус

**[Т]** **107.T** — Actic-консистентность: $\mathrm{Con}(\text{Diakrisis} + \text{Actic}) = \mathrm{Con}(\text{ZFC} + 2\text{-inacc})$, та же сила.
**[Т]** **108.T** — AC/OC-дуальность как Морита-эквивалентность в $(\infty, \infty)$-категорном смысле.
**[Т]** **109.T** — Дуал-AFN-T: absolute-act-no-go.
**[Т·L3]** **110.T–122.T** — структурные теоремы Actic.

**Позиционирование**: Actic — не альтернатива каноническому примитиву, а его формальный дуал. Каждая артикуляция $\alpha \in \langle\!\langle \cdot \rangle\!\rangle$ имеет парного актанта $\varepsilon(\alpha) \in \rangle\!\rangle \cdot \langle\!\langle$; пара $(\alpha, \varepsilon(\alpha))$ называется *артикулированной практикой*.

## 1. Почему это фундаментально

Диакрисис в его нынешней форме — **объект-центричен** (ОЦ). Артикуляции $\alpha_F$ — точки; Морита-эквивалентности — морфизмы; $\mathfrak{M}_\mathrm{Fnd}$ — классифицирующее пространство объектов. Это полностью соответствует западной no-go традиции (Cantor → Russell → Gödel → Tarski → Lawvere → Ernst → AFN-T): теорема о невозможности *объекта*.
...
**Actic формализует акт**. Он вводит параллельный к каноническому примитиву ДЦ-примитив — $(\rangle\!\rangle \cdot \langle\!\langle, \mathsf{A}, \varepsilon_\mathrm{math}, \sqsupset_\bullet)$ — плюс 13 дуальных аксиом, и доказывает: два примитива **формально дуальны**, не соперничают. ОЦ-Диакрисис и ДЦ-Актика — две проекции одной $(\infty, \infty)$-категорной структуры.

Это выход за Метастемологию Чурилова, которая ставила ДЦ *против* ОЦ. Здесь мы показываем: корректная ДЦ-теория **включает** ОЦ через дуальность. Никто до нас этого не делал формально.

## 2. Предельная полная историческая линия ДЦ-мысли

Метастемология Чурилова цитирует пять источников (Боярин, Бахтияров, Анохин, Щедровицкий, Мартынов). Этого недостаточно — действие-центричное мышление имеет гораздо более глубокую и широкую родословную. Actic поглощает следующие 35+ традиций.

### 2.1 Досократическая и античная линия

| Автор | Акт-первичный вклад | Соответствие в Actic |
|---|---|---|
...
| Автор | Акт-первичный вклад |
|---|---|
| **Bergson** | *Durée* — первичная длительность; élan vital; интеллект объективирует, интуиция схватывает процесс |
| **James** | Pure experience; поток сознания |
| **Peirce** | Прагматизм: значение = привычка действия |
| **Dewey** | Опыт = акт-претерпевание единым |
| **Whitehead** | *Actual occasions*: реальность состоит из актуальных событий; объекты — абстракции из них |
| **Heidegger** | *Ereignis*; забота как структура Dasein; бытие как событие |
| **Merleau-Ponty** | Телесное действие как первичная структура смысла |
| **Simondon** | Индивидуация как *процесс*; индивид — стабильная фаза |
| **Deleuze** | Различие как активное самоутверждение; линии ускользания |

**Whitehead** даёт важнейшее для нас: **actual occasion** — это атомарный акт, и мир = сеть actual occasions. Каждый objet — это абстрактный *prehension-pattern* поверх актуальных событий. В наших терминах: $\alpha = $ паттерн; $\varepsilon(\alpha) = $ сам акт prehension. Это предлагает естественную *топологию событий* для ε-инварианта.

**Simondon**: индивидуация как процесс — прямое предшествование нашей дуальности. α = «индивид» (стабилизированная фаза); ε(α) = индивидуация (процесс-формирование).

### 2.4 Феноменологическая и биосемиотическая линия ХХ в.

| Автор | Акт-первичный вклад |
|---|---|
| **Bateson** | Паттерн, соединяющий — отношения *через* акты |
| **Maturana–Varela** | Autopoiesis: живое как *самовоспроизводящая активность* |
| **Varela** | Enactivism: cognition = sensorimotor coupling, акт-констититивен |
| **Thompson E.** | Mind in life: когнитивный акт как эволюционное продолжение метаболического |

**Autopoiesis** — прямое применение: живая система = класс практик, поддерживающих себя. В Actic это класс $\varepsilon$-актов, замкнутый под $\mathsf{A}$-активацией. Мы доказываем ниже (113.T), что autopoietic-замкнутость = $\mathsf{A}$-фиксточка.
...
| **Чурилов** | Управляемая эпистемология → Метастемология |

Это core русско-советской ДЦ-традиции. Наш проект берёт её как **один из подмножеств покрываемой территории**, а не единственный. Это расширяет и формализует её; мы далее (§6) покажем, как Метастемология Чурилова есть частный случай Actic.

### 2.6 Формально-логическая ДЦ-линия (критично важная, у Чурилова отсутствует!)
...
| Автор | Акт-первичный вклад |
|---|---|
| **Brouwer** | Интуиционизм: доказательство = конструкция-акт, не объективная истина |
| **Heyting** | BHK-интерпретация: $\mathrm{proof}(A)$ = метод/акт конструирования |
| **Gentzen** | Естественная дедукция: правила как *акт-схемы* |
| **Lorenzen** | Диалогическая логика: доказательство = диалог-игра между Proponent и Opponent |
| **Curry, Howard** | Proofs-as-programs: программа = акт вычисления доказательства |
| **Martin-Löf** | Meanings-as-practices: значение = социально стабилизированная практика |
| **Hintikka, Väänänen** | Game-theoretic semantics: истина = выигрышная стратегия |
| **Girard** | Ludics: доказательства как designs, интеракция-первична |
| **Abramsky, Jagadeesan** | Game semantics for PL: программы как стратегии |
...
| **Plotkin** | Structural operational semantics: значение = правила редукции (актов) |

**Brouwer** — основоположник. Для интуициониста доказательство не есть объективный факт, но *акт построения*. Мартин-Лёф явно сказал: "значение типа — это то, что значит его построить". Это уже ДЦ, но встроенная в формальную математику.

**Girard-ludics** — это максимально строгая ДЦ-формализация: доказательство — это *design*, набор выборов в дереве интеракции. Логика становится теорией игры против неограниченного оппонента. Для нас это важно: *ludics дуален обычной proof theory так же, как Actic дуален Canonical Primitive*.

Это подводит к ключевому техническому результату: **Diakrisis + Actic = категорно-дуальный аналог (proof theory + ludics)**.
...
$$
\text{Actic-примитив} = (\rangle\!\rangle \cdot \langle\!\langle,\; \mathsf{A},\; \varepsilon_\mathrm{math},\; \sqsupset_\bullet)
$$
...
Для каждой Axi-$i$ канонического примитива есть дуальный A-$i$ в Actic. Ключевые:
...
**Теорема 107.T** [Т, Actic-консистентность]. Модель метакатегории активности $\mathbf{Act}$ (категория симплициальных множеств с Kan-расширениями) удовлетворяет A-0..A-9 + T-ε + T-2a\* + T-ε_c и имеет ту же силу консистентности, что Axi-0..9 + T-α + T-2f\* в $\mathbf{Cat}$: $\mathrm{Con}(\text{Diakrisis}+\text{Actic}) = \mathrm{Con}(\mathrm{ZFC} + 2\text{-inacc})$.

*Доказательство*. $\mathbf{Act}$ живёт в том же Grothendieck-universe $\mathbf{U}_1 \subset \mathbf{U}_2$; дуальные аксиомы удовлетворяются дуальной моделью. Обе аксиоматики совместны при одинаковых кардинальных допущениях. ∎
...
**108.T** [Т·L3, **фундаментальная теорема Actic**]. *Существует канонический функтор*
$$
...
Это самый глубокий технический вклад Actic. Сформально: $\varepsilon$ — это *Yoneda-эквивалентность* между оп-категорией актов и оригинальной категорией артикуляций (с точностью до когерентности).

### 5.3 Доказательство (набросок, полное — в `01-dual-primitive.md`)

Стратегия: дуализация Морита-quotient-конструкции 43.T1.

**Шаг 1.** Для каждой артикуляции $\alpha \in \langle\!\langle \cdot \rangle\!\rangle$ определяем $\varepsilon(\alpha) := (\mathrm{Syn}(\alpha), \mathrm{Perf}(\alpha))$, где $\mathrm{Perf}(\alpha)$ — категория *перформансов* $\alpha$: как $\alpha$ реализуется в социальной/исторической практике математики. Это дуал Lindenbaum-Tarski конструкции: вместо «формулы по модулю equivalence» мы берём «практики по модулю gauge».
...
**Шаг 5.** $(\infty, \infty)$-расширение через Barwick–Schommer-Pries unicity, как в 102.T. ∎
...
## 7. Дополнительные теоремы Actic (110.T–122.T)

- **110.T** — Перевод (translate): каждая практика $\varepsilon_1$ переводима в $\varepsilon_2$ ⟺ $\alpha_1 \sim_M \alpha_2$.
- **111.T** — autopoiesis как $\mathsf{A}$-фиксточка: живая/автопоэтическая система = $\varepsilon \in \mathrm{Fix}(\mathsf{A})$.
...
- **114.T** — 102.T-дуал: meta-activation stabilization с universe-ascent для ε-корней.
- **115.T** — Whitehead-Coordinate: $\varepsilon_\mathrm{prehension} \in \rangle\!\rangle \cdot \langle\!\langle$ даёт базис для описания квантовых измерений как актов.
- **116.T** — Brouwer-embedding: BHK-proofs вкладываются в $\rangle\!\rangle \cdot \langle\!\langle$ как $\varepsilon_\mathrm{construct}$-семейство.
- **117.T** — Girard-ludics соответствие: ludic-designs — это объекты $\rangle\!\rangle \cdot \langle\!\langle^\mathrm{interact}$, полной под-2-категории.
- **118.T** — Martin-Löf meanings-as-practices формализация: $\mathrm{Meaning}(T) = \varepsilon(\alpha_T)$.
- **119.T** — Hintikka-game соответствие: истинность = выигрышная стратегия в соответствующем $\varepsilon_\mathrm{dialogue}$.
- **120.T** — Actor-model embedding: Hewitt-акторы = объекты $\rangle\!\rangle \cdot \langle\!\langle^\mathrm{concurrent}$.
- **121.T** — Autopoiesis characterization: Maturana-Varela system = $(\mathsf{A}, \mathrm{Fix})$-замкнутый подкласс.
...
Метастемология Чурилова ценна как первый современный ДЦ-проект в русскоязычной традиции, но ограничена. Actic превосходит её по шести осям:
...
**Actic**: 108.T — формальная $(\infty, \infty)$-эквивалентность; 109.T — формальная теорема дуал-no-go; 107.T — формальная consistency.

### 8.2 Ось 2: интеграция с ОЦ

**Чурилов**: ДЦ vs ОЦ — дихотомия; выбор между объект-центричным и действие-центричным подходами. Предпочтение ДЦ декларируется, но не обосновывается иначе чем пpагматически.

**Actic**: ДЦ и ОЦ — **дуалы по 108.T**. Не выбор, а двойная проекция одной структуры. Обе необходимы; ни одна не первичнее.
...
**Actic**: $(\infty, \infty)$-категорная структура актов; ε-инвариант от 0 до $\Omega$; каталог актов от $\varepsilon_\mathrm{compute}$ ($\omega$) до $\varepsilon_\mathrm{Apeiron}$ ($\Omega$). Покрывает все масштабы от атомарного события до апейрон-акта.

### 8.4 Ось 4: вычислимость

**Чурилов**: прототип в Google Docs; метатекстовый процессор — концепт, не реализация.

**Actic**: прямо соответствует Verum-stdlib модулям: `core.action.event`, `core.action.practice`, `core.action.institution`. См. §10.

### 8.5 Ось 5: покрытие традиций

**Чурилов**: 5 источников (Боярин, Бахтияров, Анохин, Щедровицкий, Мартынов) — только русскоязычная инженерно-когнитивная традиция.

**Actic**: 35+ традиций, от Анаксимандра до Girard. §2 выше — полный каталог. Включая всю формально-логическую ДЦ-линию (Brouwer, Martin-Löf, Girard, Hintikka), отсутствующую у Чурилова.
...
**Actic**: 107.T formally консистентна; 109.T — дуал AFN-T с пятиосевой абсолютностью. Actic-завершена как теория.

### 8.7 Итог: Actic $\supset$ Metastemology

Формально: всякая структура, описанная в Метастемологии, вкладывается в Actic как подклассификатор. Например:
...
## 9. Место Actic в архитектуре Diakrisis
...
Добавление Actic к Diakrisis немедленно даёт Verum три новых stdlib модуля:
...
Verum paper v2 указывает 4 correspondence theorems (OC-стороны): `@framework` ↔ $\LFnd$, protocols ↔ $\LCls$, kernel ↔ T-2f\*, `@verify` ↔ $\nu$. С добавлением Actic появляются 4 дуальных:

| OC-correspondence | AC-correspondence |
|---|---|
| `@framework(name, cit)` ↔ $\LFnd$-point | `@practice(name, cit)` ↔ $\mathfrak{L}^\mathrm{act}_\mathrm{Fnd}$-point |
...
Noesis (§11 Diakrisis docs) была определена как платформа «знаний о знаниях». С Actic это уточняется:
...
## 12. Открытые задачи Actic (для будущих работ)

1. **Enacted-UHM**: полная спецификация $\varepsilon_\mathrm{uhm}$ — как УГМ *ведётся*, не только артикулируется.
2. **Formal categoricity of Actic-core**: доказать, что $\rangle\!\rangle \cdot \langle\!\langle$ канонически единственна до $(\infty, \infty)$-эквивалентности (дуал 88.T).
...
5. **Actic-Noesis → enacted epistemology**: заменить Чуриловскую metaстемологию полной ε-теорией.
6. **Dialogical embedding**: формализовать ludics Girard и диалогическую логику Lorenzen как теории актов.

## 13. Итог

Actic — **не альтернатива** Diakrisis-ОЦ, а его **каноническая дуальная ветвь**. 108.T устанавливает Морита-эквивалентность двух описаний. 109.T даёт дуал-AFN-T. Вместе — **формальное завершение ДЦ-стороны Diakrisis на уровне MSFS-строгости**.

Относительно Метастемологии Чурилова: Actic поглощает её как частный случай (§8.7), формализует её содержательные конструкты (ОКА, ММП, стема, эвалы, fuga incertitudinem, 4 останова) как частные случаи общих Actic-структур, и — критично — **включает формально-логическую ДЦ-линию** (Brouwer → Martin-Löf → Girard → Lorenzen → Hintikka → game semantics → process calculi → actor model), которой у Чурилова нет.
...
Следующие шаги: (а) детальные дочерние документы `01`–`09`; (б) формализация 107.T–122.T с полными доказательствами; (в) Verum-stdlib модули `core.action.*`; (г) Actic-Verum companion-paper (кандидат C3 roadmap).
...
- [`/10-reference/02-theorems-catalog`](/10-reference/02-theorems-catalog) — каталог теорем (расширяется 107.T–122.T).
- [`/10-reference/04-afn-t-correspondence`](/10-reference/04-afn-t-correspondence) — MSFS ↔ Diakrisis, расширяется Actic-колонкой.
...
- `06-actic-theorems.md` — 110.T–122.T с доказательствами;
- `07-beyond-metastemology.md` — детальное вложение Чурилова;
- `08-formal-logical-dc.md` — Brouwer/Martin-Löf/Girard/Lorenzen/Hintikka интеграция;
