...
>
> Актика (от греч. ἄκτος, лат. *actus* — «акт, действие») — формальный действие-центричный (ДЦ) дуал канонического примитива. Дополняет ⟪·⟫-стек Диакрисиса двойственным ⟫·⟪-стеком актов и энактментов, между которыми установлена категорная Морита-дуальность, а не оппозиция.
>
> *Терминологическое примечание*: термин «Актика» используется параллельно в постсоветском психонетическом дискурсе (М. Боярин, лингвистический семинар Психонетического сообщества О. Бахтиярова, Подмосковье, 2013) — как проязык порождения смыслов на основе санскритской Вьякараны и Упанишад с центральной триадой Имя–Форма–Действие. Наше использование термина — формальная математическая теория акт-двойственного основания; общим у двух проектов является только название и интуиция первичности действия, философские основания существенно различны (санскритско-психонетическое vs категорно-формальное).
...
**[Т]** **109.T** — Дуал-AFN-T: абсолютно-акт-no-go.
...
Это формальное расширение Метастемологии Е. Чурилова (anticomplexity.org, программа с 2009 г., оформление как «Метастемология вместо Манифеста» с ~2015 г.). Метастемология формулирует *иерархическую интеграцию*: ДЦ — фундаментальный слой рефлексивных обратных связей (в духе ТФС П.К. Анохина), на котором ОЦ-знание оперирует как абстрагированный над-слой, и над которым располагается Понимание (Understanding) как мета-слой управления схемами. Эта иерархия содержательно описана у Чурилова, но не категорно формализована. Актика берёт эту иерархию как философский ориентир и устанавливает над ней формальную $(\infty, \infty)$-категорную **дуальность** через 108.T (AC/OC Морита-эквивалентность): ДЦ и ОЦ — не два слоя одной башни, а две равноправные проекции одной структуры. Это категорное усиление иерархического подхода Чурилова, не замещение его.

## 2. Предельная полная историческая линия ДЦ-мысли

Метастемология Чурилова опирается на разнородный, но прагматически-ориентированный круг источников (верифицировано по anticomplexity.org): буддийская традиция (Гаутама, Mūlapariyāya-sutta, дзэн-коаны), исихазм; Греймас (теория актантов), Латур (акторно-сетевая теория), Кун (парадигма), Канеман (быстрое/медленное), Уильямсон (knowledge-first эпистемология); П.К. Анохин (теория функциональных систем), К.В. Анохин (современная нейронаука), Г.П. Щедровицкий (СМД-методология), М.М. Бахтин (активное сознание). Это ценный, но **избирательный** круг. Он не охватывает:
...
| **Анохин П.К.** | Теория функциональных систем (ТФС): предвосхищающий акт целеполагания, акцептор результата действия |
| **Анохин К.В.** | Современная нейронаука: гиперсетевая теория мозга, когнитом |
| **Щедровицкий Г.П.** | СМД — системо-мыследеятельность: мышление + коммуникация + действие как единое |
| **Бахтин М.М.** | Активное сознание; диалогическая природа высказывания |
| **Мамардашвили** | Акт мысли как онтологическое событие |
| **Чурилов Е.** | Метастемология (anticomplexity.org, программа с 2009 г., оформление с ~2015 г.); опорная когнитивная архитектура (ОКА), стема, ММП, эвалы; иерархическая интеграция ДЦ → ОЦ → Понимание |

Это ядро русско-советской ДЦ-традиции в той части, что цитируется Чуриловым и/или формирует фон Актика. Наш проект берёт её как **одно из подмножеств покрываемой территории**, а не единственный источник. Это расширяет и формализует её; мы далее (§6) покажем, как Метастемология Чурилова формально расширяется через Актика.
...
## 8. Формальное расширение Метастемологии — 6 осей дополнения

Метастемология Чурилова — содержательно проработанный современный ДЦ-проект в русскоязычной традиции (anticomplexity.org, программа с 2009 г., ≥341 публикация на 2026 г., 20 архивных страниц). Актика формально расширяет её по шести осям:
...
**Чурилов**: иерархическая интеграция. ДЦ — фундаментальный слой рефлексивных контуров (в духе ТФС П.К. Анохина); ОЦ-знание оперирует поверх него как абстрагированная структура без временно́й координаты; Понимание — мета-слой управления схемами над ОЦ. Иерархия описана содержательно, без формализации связи между слоями.

**Актика**: ДЦ и ОЦ — **дуалы по 108.T**. Не три слоя одной башни, а две равноправные проекции одной $(\infty, \infty)$-категорной структуры. Обе необходимы; ни одна не первичнее. Это категорное усиление иерархической схемы Чурилова: вертикальная иерархия Метастемологии переходит в горизонтальную дуальность через формальную $(\infty, \infty)$-эквивалентность $\mathfrak{M}_\mathrm{Fnd} \simeq \mathfrak{E}_\mathrm{Fnd}$.
...
**Чурилов** (верифицировано по anticomplexity.org): буддийская философия и исихазм; Греймас, Латур, Кун, Канеман, Уильямсон; П.К. Анохин (ТФС), К.В. Анохин (нейронаука), Г.П. Щедровицкий (СМД), М.М. Бахтин. Не охватывает: процессуальная философия XX в. (Уайтхед, Варела, Бейтсон), классическая ДЦ-линия (Фихте, Аристотель-энергейя), и — критично — формально-логическая ДЦ.

**Актика**: 35+ традиций, от Анаксимандра до Жирара. §2 выше — полный каталог. Включая всю формально-логическую ДЦ-линию (Брауэр, Мартин-Лёф, Жирар, Хинтикка), не охваченную у Чурилова, и всю процессуальную философию (Уайтхед, Варела, Бейтсон).
...
### 8.7 Итог: формальное расширение, не замещение

Формально: каждая ключевая структура Метастемологии получает категорное представление как подклассификатор Актика. Соответствие:
- ОКА (трёхслойная архитектура реактивный $\to$ рефлексия-1 $\to$ рефлексия-2) = 3-слойный $\rangle\!\rangle \cdot \langle\!\langle^\mathrm{cog}$-подфрагмент с фильтрацией по $\varepsilon$.
- ММП (метатекстовый процессор) = ε-стратифицированные подсистемы с accessibility.
- Стема (терминологический мост между конструктами теорий) = 1-морфизм в $\rangle\!\rangle \cdot \langle\!\langle$ через общий перформанс-паттерн уровня $\varepsilon < \omega \cdot 2$.
- Эвалы (оценочные компоненты в beyond-LLM агентных архитектурах) = 4-функциональная спецификация, дуальная R-S-условиям MSFS.
- Fuga incertitudinem (синтактический побег от неопределённости) = частный случай T-2a\*-депт-стратификации.
- 4 типа остановов = частные случаи дуальной 5-осевой абсолютности.

Ключевая координата иерархии Чурилова (ДЦ $\to$ ОЦ $\to$ Понимание) переходит в категорное соответствие: ДЦ-слой ↔ Актика-проекция, ОЦ-слой ↔ Diakrisis-проекция, переход между ними ↔ функтор $\varepsilon \dashv \alpha$ дуальности 108.T. Метастемологическое Понимание как мета-слой управления схемами переходит в работу Cls-функтора над $\mathfrak{M}_\mathrm{Fnd}$ (мета-классификация уровня L_Cls в MSFS).
...
5. **Актика-Noesis $\to$ enacted epistemology**: формально расширить Метастемологию Чурилова полной ε-теорией с категорной дуальностью.
...
Относительно Метастемологии Чурилова: Актика формально расширяет её (§8.7), сохраняя содержательные конструкты (ОКА, ММП, стема, эвалы, fuga incertitudinem, 4 останова) как частные случаи общих Актика-структур, и — критично — **включает формально-логическую ДЦ-линию** (Брауэр $\to$ Мартин-Лёф $\to$ Жирар $\to$ Лоренцен $\to$ Хинтикка $\to$ теоретико-игровая семантика $\to$ исчисления процессов $\to$ actor-модель), не охваченную в Метастемологии. Иерархия Чурилова (ДЦ $\to$ ОЦ $\to$ Понимание) сохраняется как философский ориентир и категорно усиливается через 108.T-дуальность.
...
- `07-beyond-metastemology.md` — детальное формальное расширение Метастемологии Чурилова;
