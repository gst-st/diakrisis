...
- Всю западную процессуальную философию XX века (Whitehead, Varela, Bateson — прямые предшественники ДЦ).
- Всю формально-логическую ДЦ-линию (Brouwer, Martin-Löf, Girard, Lorenzen, Hintikka) — самый технически сильный ресурс для формализации.
...
**Autopoiesis** — прямое применение: живая система = класс практик, поддерживающих себя. В Актика это класс $\varepsilon$-актов, замкнутый под $\mathsf{A}$-активацией. Мы доказываем ниже (113.T), что autopoietic-замкнутость = $\mathsf{A}$-фиксточка.
...
| **Hintikka, Väänänen** | Теоретико-игровая семантика: истина = выигрышная стратегия |
...
**Girard-ludics** — это максимально строгая ДЦ-формализация: доказательство — это *design*, набор выборов в дереве интеракции. Логика становится теорией игры против неограниченного оппонента. Для нас это важно: *ludics дуален обычной proof theory так же, как Актика дуален Canonical Primitive*.
...
Это самый глубокий технический вклад Актика. Сформально: $\varepsilon$ — это *Yoneda-эквивалентность* между оп-категорией актов и оригинальной категорией артикуляций (с точностью до когерентности).
...
**Чурилов**: прагматически-избирательный круг источников (буддийская философия и исихазм; Greimas, Latour, Kuhn, Kahneman, Williamson; К.В. Анохин, Г.П. Щедровицкий; соавторы-лекторы Боярин и Бахтияров). Отсутствует: процессуальная философия XX века (Whitehead, Varela, Bateson), классическая ДЦ-линия (Фихте, Аристотель-энергейя), и — критично — вся формально-логическая ДЦ.

**Актика**: 35+ традиций, от Анаксимандра до Girard. §2 выше — полный каталог. Включая всю формально-логическую ДЦ-линию (Brouwer, Martin-Löf, Girard, Hintikka), отсутствующую у Чурилова, и всю процессуальную философию (Whitehead, Varela, Bateson).
