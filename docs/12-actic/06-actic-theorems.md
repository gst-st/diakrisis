...
**Шаг 2** (корректная определённость). По 102.T-дуалу мета-стабилизация на $(\infty, \infty)$-уровне работает с восхождение по универсумам; ординал $\beta$ ограничен сверху $\kappa_2$ для R-S актов.
