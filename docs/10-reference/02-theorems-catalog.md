...
- **[Т] (полные доказательства)**: **~105** — подавляющее большинство.
- **[Т-набр] (строгие наброски)**: **4** — 08.T2, 08.T3, 08.T4, 12.T3 (специфика модели / требует выбора quantum type theory).
