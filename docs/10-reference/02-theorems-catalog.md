...
- **87.T** [П·L3] — Postulate (методологический): в пределах Lawvere-characterizable foundations 4-мерная абсолютность полна. Не математическая теорема в строгом смысле — опирается на философскую характеризацию Lawvere (1969). Scope-limited.
...
- **[Т·L2] (стандартная редукция + проверенная адаптация)**: ~50 теорем — большинство non-classical (48.T-54.T, 57.T), structural (11-16, 22-26), 91.T-93.T.
- **[Т·L3] (redукция + ожидаемо-рутинная адаптация)**: ~25 теорем — включая 85.T UFH, 87.T (постулат), 88.T-90.T (Lair/Yoneda расширения на (∞,∞)), 94.T-96.T ((∞,∞)-extensions).
- **[П·L3]**: **87.T** — явно признан постулатом (не теоремой).
