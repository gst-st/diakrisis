...
- **29.T** [Т] — каждая Rich-F имеет единственное α_F ∈ Trace(𝖠) (через Yoneda + R5 categorical semantics).
- **30.T** [Т] — реконструкция: из ρ(α_F) восстанавливается α_F (обратное Yoneda).
- **43.T1** [Т] — Trace(𝖠)/gauge ≃ 𝓜_Fnd как 2-stack (Deligne-Mumford quotient + 2-categorical generalization).
