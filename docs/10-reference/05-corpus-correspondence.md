...
| Тема | MSFS | Diakrisis | Актика | УГМ | Noesis |
|---|---|---|---|---|---|
| (Max-1) универсальная артикуляция | (Max-1) в def:maximality | 103.T | (Diakrisis-only) | — | — |
| (Max-2) калибровочная полнота | (Max-2) в def:maximality | 104.T | (Diakrisis-only) | — | — |
| (Max-3) парадокс-иммунность | (Max-3) в def:maximality | 105.T | 113.T (дуал. T-2a*) | — | NO-10 (Ловер-bound) |
| (Max-4) срез-локальность | Theorem~
ef{thm:срез-локальность} | 99.T | (Diakrisis-only) | — | — |
...
| Three bypass paths | Theorems~\ref{thm:universe}, \ref{thm:reflective}, \ref{thm:срез-локальность} | 57.T, 68.T, 98.T+99.T | — | — | — |
