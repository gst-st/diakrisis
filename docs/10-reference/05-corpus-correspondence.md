...
| Тема | MSFS | Diakrisis | Актика | УГМ | Noesis |
|---|---|---|---|---|---|
| M1–M5 классификаторы | Definition~\ref{def:meta} | 06-limits/09-meta-classification | (дуал. через 108.T) | — | NO-12 (structural superiority) |
| Meta-categoricity | Theorem~\ref{thm:meta-cat} | 100.T | — | — | NO-1 (Noesis.Core уникальность) |
| Meta-multiplicity | Theorem~\ref{thm:meta-mult} | 101.T | — | — | — |
| Meta-stabilisation | Theorem~\ref{thm:meta-stab} | 102.T | 108.C5 (дуал) | — | — |
| $\infty$-cosmoi Riehl–Verity | §3 examples | 04-extractions/07-cosmoi | — | — | — |
| Univalent Foundations Voevodsky | §3 examples | 04-extractions/04-hott | — | — | — |
| Cohesive Schreiber | §3 examples | 04-extractions/08-cohesive | — | — | — |
...
| (Max-3) парадокс-иммунность | (Max-3) в def:maximality | 105.T | 113.T (дуал. T-2a*) | — | NO-10 (Lawvere-bound) |
| (Max-4) slice-locality | Theorem~\ref{thm:slice-locality} | 99.T | (Diakrisis-only) | — | — |
...
| AFN-T (α)-part | Theorem~\ref{thm:afnt-alpha} | 06-limits/02-th-final | — | — | NO-3, NO-9, NO-17 (AFN-T filter) |
| AFN-T (β)-part | Theorem~\ref{thm:afnt-beta} | 06-limits/02-th-final | — | — | — |
| Combined AFN-T | Theorem~\ref{thm:afnt} | 06-limits/02-th-final | — | — | — |
| Five-axis absoluteness | Theorem~\ref{thm:five-axis} | 55.T, 59.T.1, 69.T, 84.T, 87.T | — | — | — |
...
| AC/OC Morita duality | Theorem~\ref{thm:ac-oc-duality} | 108.T | 04-ac-oc-duality | ε_uhm через 108.T (05-assemblies/01-uhm §ДЦ-дуал) | — |
| Dual-AFN-T | Theorem~\ref{thm:dual-afnt} | 109.T | 05-dual-afn-t | граница амбиций УГМ (05-assemblies/01-uhm §ДЦ-дуал) | — |
| Conservativity | Corollary~\ref{cor:ac-oc-conservativity} | 107.T | 04-ac-oc-duality | — | — |
| Dual five-axis | Theorem~\ref{thm:dual-five-axis} | (вспом.) | 04-ac-oc-duality §6 | — | — |
...
| 113.T | 12-actic/06-actic-theorems §4 | ω² | Russell-act-immunity | — | — |
...
| 126.T | 12-actic/06-actic-theorems §14.4 | ω+k | Hintikka–Abramsky параллель | — | — |
...
| T-222 (MRQT-Lawvere, 23 монотона) | [Т] | G₂-ковариантность на α_uhm | — | — |
...
| NO-6 | Федерация (Pronk BF1-BF5) | 43.T1 + спуск | — | — |
...
| NO-18 | Эквивалентность Verum ↔ Diakrisis | 89.T, Lambek-Scott | — | — |
