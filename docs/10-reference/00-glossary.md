...
**Тип**: содержательный предшественник Актика в русскоязычной традиции (программа с 2009 г., оформление термина «метастемология» с ~2015 г.; ресурс anticomplexity.org).
**ε-координата**: $\omega \cdot 2 + 1$ (125.T).
**Соотношение**: Чурилов формулирует *иерархическую интеграцию* ДЦ → ОЦ → Понимание (рефлексивная ДЦ-практика как фундаментальный слой, на котором ОЦ-знание оперирует, а Понимание — мета-слой управления схемами); Актика — *формальное расширение* этой иерархии через категорную $(\infty,\infty)$-Морита-дуальность ОЦ- и ДЦ-проекций (108.T), без замещения содержательного ядра.
