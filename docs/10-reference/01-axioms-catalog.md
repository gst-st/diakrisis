...
## Полный список (13 аксиом: Axi-0..Axi-9 + T-α + T-2f\* + T-2f\*\*)
...
**Следствия**: калибровочной свобода; совместимость с классическими и конструктивными gauge-классами.
...
**Следствия**: Рассел-иммунитет; универсальная парадокс-иммунность для Яновский-сводимых парадоксов (105.T).

### T-2f\*\* — модальная стратификация (теорема 130.T)

Усиление T-2f\* условием $\mathrm{md}(P) < \mathrm{md}(\alpha_P)$, где $\mathrm{md}$ — модально-определимостный ранг (см. [`/02-canonical-primitive/02-axiomatics`](/02-canonical-primitive/02-axiomatics) §T-2f\*\*).

**Статус**: [П]/[Т·130.T] (130.T доказывает блокировку Berry, парадоксального применения Лёба, паранепротиворечивого Curry).
**Verum**: расширение T-2f\* машинерии модальным рангом.
**Следствия**: парадокс-иммунность за пределами Яновский-сводимости; T-2f\*\* ⇒ T-2f\* (130.L1); стандартная теорема Лёба GL/PA сохраняется (130.L2).
