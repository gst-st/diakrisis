...
**105.T** ([`/06-limits/10-maximality-theorems`](/06-limits/10-maximality-theorems)): **универсальная иммунность** — T-2f\* блокирует *любой* Yanofsky-сводимый самореферентный парадокс (Yanofsky 2003), а не только именные 5 семейств. Ключ: $\mathrm{dp}(T^Y) = \mathrm{dp}(Y)+1$ — экспоненциал на один depth выше; слабая точечная сюръективность требует depth-сохранения; T-2f\* строгое неравенство → w.p.s. невозможно → все диагональные парадоксы заблокированы.

#### Именные семьи парадоксов (частные случаи Yanofsky)
...
6. *Через 105.T*: также Cantor, Tarski, Lawvere, Gödel-type, Löb, и любой другой Yanofsky-сводимый парадокс.
