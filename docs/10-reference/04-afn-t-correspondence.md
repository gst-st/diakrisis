...
| Diakrisis | MSFS | Название |
|---|---|---|
| **100.T** | Theorem~ef{thm:meta-cat} | Условная мета-категоричность (через Гротендик–Lurie straightening) |
