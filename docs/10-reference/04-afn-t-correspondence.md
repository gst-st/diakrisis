...
| **108.T** | Theorem~\ref{thm:ac-oc-duality} | AC/OC Морита-дуальность: $\fM \simeq_{(\infty, \infty)} \fM_\cE$ через adjoint pair $\varepsilon \dashv \alpha$ |
...
| **109.T** | Theorem~\ref{thm:dual-afnt} | Dual Boundary Lemma: $\LAbsE = \emptyset$ двумя независимыми путями |
| (вспом.) | Theorem~\ref{thm:dual-five-axis} | Dual five-axis absoluteness (дуал Theorem~\ref{thm:five-axis}) |
...
| $\mathfrak{E}_\mathrm{Fnd}$ | $\fM_\cE$ (Theorem~\ref{thm:ac-oc-duality}) | Classifying $2$-stack of $\cE$ |
