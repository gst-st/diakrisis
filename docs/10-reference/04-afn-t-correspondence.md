---
sidebar_position: 4
title: Соответствие препринта MSFS
---
...
**При цитировании:** для внешних публикаций предпочитаемая ссылка — препринт MSFS (self-contained, рецензируем); Diakrisis-документы ссылаются как source-материал корпуса.
