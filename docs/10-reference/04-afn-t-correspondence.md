...
| **87.T** | Theorem~
ef{thm:completeness} | Полнота (условия Ловера) |
...
| **99.T** | Theorem~
ef{thm:срез-локальность} | Slice-локальность $\II$ (через топос $\mathrm{Eff}$ Хайланда) |
...
| **102.T** | Theorem~
ef{thm:meta-stab} | Theory-level meta-стабилизация с восхождение по универсумам ($\kappa_1 < \kappa_2 < \ldots$) |
| **68.T** | Theorem~
...
|---|---|---|
| (Max-1) универсальная артикуляция | **103.T** | $\mathrm{Artic}: \mathcal{F} \to \langle\!\langle \cdot \rangle\!\rangle$ существенно сюръективен |
| (Max-2) калибровочная полнота | **104.T** | $\mathrm{Aut}_2(\langle\!\langle \cdot \rangle\!\rangle) \twoheadrightarrow \pi_0 \mathrm{Aut}_2(\fM_\mathrm{Fnd})$ |
| (Max-3) парадокс-иммунность | **105.T** | Универсальный Яновский-блокировщик через T-2f\* |
| (Max-4) срез-локальность | **99.T** (MSFS `thm:срез-локальность`); сводная теорема **106.T** | Интенсиональное уточнение fibres, не экспандирует базу |
...
### Доказательства максимальности (Diakrisis-only, не в MSFS)

| Diakrisis | Соответствие в MSFS | Название |
|---|---|---|
| **103.T** | (Max-1) в Definition `def:maximality` | Универсальная артикуляция: $\mathrm{Artic}: \mathcal{F} \to \langle\!\langle \cdot \rangle\!\rangle$ существенно-сюръективен |
...
| **43.T1** (классифицирующее пространство) | Convention~\ref{conv:notation} ($\fM$ через Гротендик construction) | $\mathfrak{M}_\mathrm{Fnd}$ = $\fM$ |
...
**Обоснование мнемонической нотации**: MSFS §2.3 даёт формальное обоснование через Proposition~\ref{prop:no-collapse} (non-collapse of the horizontal meta at $\mathcal{L}_{\mathrm{Fnd}}$) и на теоретическом уровне стабилизация (Theorem~
